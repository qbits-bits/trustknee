...
entities = {
    "Subjects": {
        ...
        "kind": "ref",
        "pk": "subject_id (PK)",
        "attrs": ["gender", "height_cm", "weight_kg", "age_years", "injured_leg", "pathology"],
    },
    "Trials": {
        "pos": (5.0, 8.0),
        "w": 4.2,
    ...
    "Feedback": {
        ...
        "kind": "core",
        "pk": "feedback_id (PK)",
        "attrs": ["trial_id (FK)", "source_prediction_id (FK)", "feedback_text"],
    },
    "Predictions": {
        "pos": (5.0, 0.9),
        "w": 4.2,
...
def draw_relation(ax, a, b, card_a=None, card_b=None, dashed=False):
    ...
    style = {
        "color": "#8A7A5A" if dashed else "#5D4037",
...
ax.text(
    0.4,
    12.35,
    "TrustKnee: Phase 2 Database Schema (Section 5.4)",
    fontsize=16,
    fontweight="bold",
    family=FONT,
    color="#1A2A3A",
